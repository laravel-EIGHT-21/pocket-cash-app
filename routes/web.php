...
Route::get('/Mtn/student/pocket', [SchoolsController::class, 'MtnStudentpocket'])->name('mtn.funzi.wallet.get');


Route::get('/Airtel/student/pocket', [SchoolsController::class, 'AirtelStudentpocket'])->name('airtel.funzi.wallet.get');



Route::get('/Mtn/student/pocket', [SchoolsController::class, 'MtnStudentpocketGet'])->name('mtn.student.pocket.get');


Route::get('/Airtel/student/pocket', [SchoolsController::class, 'AirtelStudentpocketGet'])->name('airtel.student.pocket.get');
