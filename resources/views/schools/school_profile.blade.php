								...
								<div class="card">
									...
									@php
										...
										<div class="d-flex flex-column align-items-center text-center">
											<img src="{{ (!empty($adminData->school_logo_path))? url('upload/logo/'.$adminData->school_logo_path):url('upload/no_image.jpg') }}"  class="rounded-circle p-1 bg-primary" width="80">
											<div class="mt-4">
