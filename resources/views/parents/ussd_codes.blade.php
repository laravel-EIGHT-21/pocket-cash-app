...
<p class="login-box-msg"><b> MTN Mobile Menu </b></p>
...
<li >
<p>(4) Payments(Choose This One)</p>
</li>
</ul>
...
<hr/>
<!--  /// Reply  -->
        <form method="GET" action="{{ route('mtn.get') }}" >

            <div class="row">
                <div class="col-sm-4 form-group">
                    <label>Enter Reply  </label>
                    <input type="text" name="mtn_ussd_code"  class="form-control" placeholder="e.g 4 For Payments">                
                </div>
