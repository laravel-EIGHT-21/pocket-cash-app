...
<p class="login-box-msg"><b> Payments Menu </b></p>
...
<li >
<p>(3) School Fees (Choose This One)</p>
</li>
...
<hr/>
<!--  /// Reply  -->
        <form method="GET" action="{{ route('mtn.school.get') }}" >

            <div class="row">
                <div class="col-sm-4 form-group">
                    <label>Enter Reply  </label>
                    <input type="text" name="mtn_ussd_code"  class="form-control" placeholder="e.g 3 For School Fees">                
                </div>
