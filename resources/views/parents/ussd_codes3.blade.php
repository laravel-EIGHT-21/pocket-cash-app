...
<p class="login-box-msg"><b> Airtel Mobile Menu </b></p>
...
<li >
<p>(1) Send Mobile Money</p>
</li>
<li >
<p>(2) Airtel & Bundles</p>
</li>
<li>
<p>(3) Pay Bill</p>
</li>
...
<li >
<p>(5) School Fees(Choose This One)</p>
</li>
</ul>
...
<hr/>
<!--  /// Reply  -->
        <form method="GET" action="{{ route('airtel.get') }}" >

            <div class="row">
                <div class="col-sm-4 form-group">
                    <label>Enter Reply  </label>
                    <input type="text" name="airtel_ussd_code"  class="form-control" placeholder="e.g 5 For School Fees">                
                </div>
