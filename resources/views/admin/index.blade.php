...
<div class="page-content">
				<div class="row row-cols-md-6 row-cols-xl-6">
                   <div class="col-md-6">
					 <div class="card radius-5 border-start border-0 border-4 border-info">
						<div class="card-body">
				...
				<div class="row row-cols-md-6 row-cols-xl-6">
                   <div class="col-md-4">
					 <div class="card radius-5 border-start border-0 border-4 border-warning">
						<div class="card-body">
						<div class="d-flex align-items-center">
								<div>
				...
				<div class="row row-cols-md-6 row-cols-xl-6">
                   <div class="col-md-4">
					 <div class="card radius-5 border-start border-0 border-4 border-dark">
						<div class="card-body">
						<div class="d-flex align-items-center">
								<div>
				  ...
				  <div class="col-md-4">
					<div class="card radius-10 border-start border-0 border-4 border-light">
					   <div class="card-body">
					   <div class="d-flex align-items-center">
								<div>
