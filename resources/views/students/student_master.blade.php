...
<head>
        <meta charset="utf-8" />
        <title>Dashboard | Funzi Wallet</title>
        ...
        <!-- plugin css -->
        <link href="{{asset('Students/assets/libs/admin-resources/jquery.vectormap/jquery-jvectormap-1.2.2.css')}}" rel="stylesheet" type="text/css" />
    ...
    <body>
                    ...
                    <ul class="list-unstyled topnav-menu float-end mb-0">
                        ...
                        <li class="dropdown notification-list topbar-dropdown">
                            <a class="nav-link dropdown-toggle nav-user me-0 waves-effect waves-light" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                                <img src="{{asset('Students/assets/images/users/avatar-1.jpg')}}" alt="user-image" class="rounded-circle">
            ...
            <div class="left-side-menu">
                ...
                <div class="h-100" data-simplebar>
                    ...
                    <div class="user-box text-center">
                        <img src="{{asset('Students/assets/images/users/avatar-1.jpg')}}" alt="user-img" title="Mat Helme"
        ...
        <!-- KNOB JS -->
        <script src="{{asset('Students/assets/libs/jquery-knob/jquery.knob.min.js')}}"></script>
        <!-- Apex js-->
        <script src="{{asset('Students/assets/libs/apexcharts/apexcharts.min.js')}}"></script>

        <!-- Plugins js-->
        <script src="{{asset('Students/assets/libs/admin-resources/jquery.vectormap/jquery-jvectormap-1.2.2.min.js')}}"></script>
        <script src="{{asset('Students/assets/libs/admin-resources/jquery.vectormap/maps/jquery-jvectormap-world-mill-en.js')}}"></script>

        <!-- Dashboard init-->
        <script src="{{asset('Students/assets/js/pages/dashboard-sales.init.js')}}"></script>
